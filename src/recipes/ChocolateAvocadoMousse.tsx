...
interface ChocolateAvocadoMousseProps {
  recipe: Recipe;
}

function ChocolateAvocadoMousse({ recipe }: ChocolateAvocadoMousseProps) {
  return (
    <Grid container rowSpacing={12} columnSpacing={{ sm: 5 }}>
      <Grid item sm={4} id="header">
        <img src={recipe.image} alt="Chocolate Avocado Mousse" />
      </Grid>
...
export default ChocolateAvocadoMousse;
